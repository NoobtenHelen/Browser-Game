...
export class WaterfallScene extends Scene {
    constructor(canvas, player, enemy) {
        ...
        new RectangularSprite(img_bridge, 175, 73, new Vector(620, 80), FOREGROUND_LAYER, true);

        const img_blätter_w = new Image;
        img_blätter_w.src = "assets/waterfall/blätter_waterfall_1.png";
